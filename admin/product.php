              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_calendar"></i> price per Kg</th>
                    <th><i class="icon_mail_alt"></i> code</th>
                  ...
                  <?php 
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" title="edit product" href="edit-product.php?id=<?= $row['id'];?>"><i class="icon_plus_alt2"></i></a>
                        <a class="btn btn-danger" href="delete-product.php?id=<?=$row['id'];?>"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                  <?php } ?>
