<?php 
                              ...
                              <script>
                               ...
                               <?php
                                        ...
                                        $query = $conn->query("SELECT * FROM customers WHERE id_number='$idno'") or die ("Unable to det details contact Oporo(brad) 0794383934");
                                        $count = $query->num_rows;
        
                                        if ($count  > 0){ 
                                    ?>
                                    <script>
                                       alert('id number/user exists');
                                    </script>
                                    <?php
                                        }
                                        else{
                                            $conn->query("INSERT INTO customers(password,firstname,lastname,email,phone_number,id_number) VALUES('$password','$firstname','$lastname','$email','$phonenumber','$idno')");
                                            header('location:login.php');
                                    ?>
                                   
                                            <script>
                                           alert("your now registered thanks to Brad");
                                            </script>
                      <?php 
...
<div class="signup-form">
    <form action="signup.php" method="POST">
        ...
        <div class="form-group">
            <input type="number" class="form-control" name="id_number" placeholder="National Id Number" required="required">
        </div>
		<div class="form-group">
		...
		<div class="form-group">
            <button type="submit" name = "ok" class="btn btn-success btn-lg btn-block">Register Now</button>
        </div>
    </form>
