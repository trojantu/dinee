        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="add-customer.php" href="orders.php">Customers orders</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon_pin_alt"></i> Pick Up Station</th>
                    <th><i class=""></i> Products</th>
                    <th><i class="icon_calendar"></i> Date of delivery</th>
                  ...
                  <?php 
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="edit-order.php?id=<?= $row['Order_id'];?>"><i class="icon_plus_alt2"></i></a>
                        <a class="btn btn-danger" href="delete-order.php?id=<?=$row['Order_id'];?>"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                  <?php } ?>
